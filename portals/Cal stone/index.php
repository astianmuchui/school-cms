            ...
            <body>
                ...
                <div class="back">
                    <a href="../../suggestions?id=14" class="hvr-forward">Make suggestion</a>
                </div>
                <br> 
                <div class="back">
                ...
                <div class="panel">
                    ...
                    <div class="cards-container">
                        <div class="card">
                            ...
                            <a href="../../control/edit_email.php?id=14" class="hvr-float">change</a>
                        </div>
                        <div class="card">
                            <p>Available Assignments</p>
                            <small><?php require "../../server/assignment_numbers.php";?></small>
                            <a href="../../assignments/?id=14" class="hvr-float">View</a>
            
                        </div>
                        <div class="card">
                            <p>Extra Exams</p>
                            <small><?php require"../../server/exam_numbers.php";?></small>
                            <a href="../../exams?id=14" class="hvr-float">View</a>
                        </div>
